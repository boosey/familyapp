...
ALTER TABLE "invitation_dismissals" ADD CONSTRAINT "invitation_dismissals_invitation_id_invitations_id_fk" FOREIGN KEY ("invitation_id") REFERENCES "public"."invitations"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
