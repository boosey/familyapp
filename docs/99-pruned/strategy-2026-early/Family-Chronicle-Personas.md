...
> ⚠️ **Superseded for product framing.** Personas here are elder-centric snapshots of Mode 1. Current roles and personas: **`docs/strategy/03-users-roles-and-personas.md`**.
