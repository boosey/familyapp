 ...
 * the audited read composition computed): steward → Endorse / Remove / Update nature (parent_of);
 * a self-endpoint subject → Hide. The server actions re-check every gate, so these flags are
