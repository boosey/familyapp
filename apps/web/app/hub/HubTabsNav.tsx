 ...
 * selected families survive navigation; the param is OMITTED when absent (absent = all). Every tab is
 * a plain `/hub?tab=<key>` switch — the routing keys are unchanged by the #124 de-clutter, only how
 * they're grouped/displayed (Requests now lives in the Family surface's sub-nav, see FamilySubNav).
 */
export function HubTabsNav({ primaryTabs, active, familiesParam }: HubTabsNavProps) {
